...
workon cv
cd /home/pi/deep-learning-face-detection
...
mjpg_streamer -o "output_http.so -w ./www" -i "input_file.so -f /home/pi/streaming_images -r stream_img.jpg -d 0" > /dev/null 2>&1 &
